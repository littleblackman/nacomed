...
class Map {
    ...
    public function setEvent_comments($event_comments) {
        if (is_string($event_comments)) {
            $this->_event_comments = $event_comments;
        }
    }
}